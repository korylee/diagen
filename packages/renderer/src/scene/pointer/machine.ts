...
import type {
  ...
  CreateLinkerDrag,
} from './linker/createLinkerDrag'
import type { CreatePan } from './viewport/createPan'
import type { CreateResize, ResizeDirection } from './shape/createResize'
import type { CreateRotate } from './shape/createRotate'
import type { CreateBoxSelection } from './viewport/createBoxSelection'
import type { CreateShapeDrag } from './shape/createShapeDrag'
...
interface CreatePointerMachineOptions {
  ...
  resize: CreateResize
  rotate: CreateRotate
  boxSelect: CreateBoxSelection
  eventToCanvas: EventToCanvas
}

export function createPointerMachine(options: CreatePointerMachineOptions) {
...
export type CreatePointerMachine = ReturnType<typeof createPointerMachine>
