...
export function LinkerCanvas(props: LinkerCanvasProps) {
  ...
  const getRoute = () => calculateLinkerRoute(props.linker, props.getShapeById);
  ...
  createEffect(on(() => [props.linker, props.viewport], () => updateCanvas()));

  const handleMouseDown = (e: MouseEvent) => {
    e.stopPropagation();
    props.onSelect?.(props.linker.id, e);
  };
